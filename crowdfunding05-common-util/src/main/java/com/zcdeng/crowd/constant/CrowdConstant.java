package com.zcdeng.crowd.constant;
...
public class CrowdConstant {
    ...
    public static final String MESSAGE_ERROR = "验证码不正确";
    public static final String MESSAGE_CODE_NOT_EXIST = "验证码无效！请检查手机号是否正确或重新发送";
    ...
    public static final String MESSAGE_DETAIL_PIC_EMPTY = "请上传详情图片";
    public static final String MESSAGE_HEADER_PIC_UPLOAD_FAILED = "头图图片上传失败";
    ...
    public static final String ATTR_NAME_REGISTER_MEMBERVO = "registerMember";
    ...
    public static final String MESSAGE_ACCESS_DENIED = "你目前没有权限访问";
