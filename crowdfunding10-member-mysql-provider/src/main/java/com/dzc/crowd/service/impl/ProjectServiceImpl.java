...
import com.dzc.crowd.entity.po.*;
import com.dzc.crowd.entity.vo.*;
import com.dzc.crowd.mapper.*;
...
public class ProjectServiceImpl implements ProjectService {
    ...
    public DetailProjectVO getDetailProjectVO(Integer projectId) {
        ...
        List<ProjectItemPicPO> projectItemPicPOList = projectItemPicPOMapper.selectByExample(projectItemPicPOExample);
        List<String> projectItemPicPath = new ArrayList<>();
        for (ProjectItemPicPO projectItemPicPO : projectItemPicPOList) {
            projectItemPicPath.add(projectItemPicPO.getItemPicPath());
        }
        detailProjectVO.setDetailPicturePathList(projectItemPicPath);
        ...
        try {
            ...
            // 获取总的众筹天数
            Integer totalDays = detailProjectVO.getLastDay();
